...
const PLATFORM_ICONS = {
  ...
  apple: '<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="7.3" r="2" fill="currentColor"/><path d="M8 18c0-3.2 1.8-7.2 4-7.2s4 4 4 7.2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',
